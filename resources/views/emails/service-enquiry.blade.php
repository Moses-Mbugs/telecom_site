...
<head>
    ...
    <title>Service Enquiry Received – Safe World Telecom</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Helvetica Neue', Arial, sans-serif; }
        ...
        .red-strip { background-color: #b5342a; padding: 12px 40px; text-align: center; }
        .red-strip p { color: #ffffff; font-size: 13px; font-weight: 600; letter-spacing: 0.05em; }
        ...
        .detail-label { font-size: 13px; font-weight: 600; color: #1e3040; width: 140px; flex-shrink: 0; }
        .detail-value { font-size: 13px; color: #475569; flex: 1; }
        .message-box { background: #fef2f2; border-left: 4px solid #b5342a; padding: 16px 20px; border-radius: 0 8px 8px 0; margin-top: 16px; }
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="header">
            <h1>Service Enquiry Received</h1>
        ...
        <div class="body">
            ...
            <p class="text">
                Thank you for reaching out to Safe World Telecom. We have received your service enquiry and a member of our team will get back to you as soon as possible — usually within 1–2 business days.
            </p>
            ...
            <div class="details-box">
                ...
                <div class="detail-row">
                    <span class="detail-label">Service of Interest</span>
                    <span class="detail-value">{{ $enquiry->service_interest }}</span>
                </div>
                @endif
                <div style="margin-top: 8px;">
                    <span class="detail-label" style="display:block; margin-bottom: 8px;">Your Message</span>
            ...
            <div class="cta-section">
                <a href="{{ config('app.url') }}/services" class="cta-btn">View Our Services</a>
            </div>
