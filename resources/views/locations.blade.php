        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300 flex flex-col">
            ...
            <div class="p-6 flex-1 flex flex-col">
                ...
                <div class="mt-auto pt-4 border-t border-gray-100">
                    @if($location->map_embed_url)
                        <button @click="selectedMap = '{{ $location->map_embed_url }}'" class="w-full text-center text-accent font-semibold hover:text-primary transition flex items-center justify-center gap-2">
                            View on Map
