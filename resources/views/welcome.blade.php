            ...
            <div class="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center justify-center h-full pb-20">
                ...
                <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl max-w-3xl w-full mx-auto transform hover:scale-[1.01] transition duration-500">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 justify-center">
                        <a href="#our-story" class="px-8 py-3 bg-[#b5342a]/90 hover:bg-[#1e3040] text-white rounded-full font-semibold transition duration-300 backdrop-blur-sm">
                            Discover Our Story
                        </a>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/2 w-full">
                    ...
                    <a href="{{ route('about') }}" class="inline-block px-8 py-3 bg-[#b5342a] text-white rounded-full font-semibold hover:bg-[#1e3040] transition duration-300 shadow-lg">
                        Explore Full Story
                    </a>
                </div>
            </div>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                {{-- Feature 1 --}}
                <div class="group p-8 rounded-3xl bg-gray-50 hover:bg-[#b5342a] hover:text-white transition-all duration-500 shadow-lg hover:shadow-2xl transform hover:-translate-y-2">
                    <div class="w-16 h-16 bg-red-100 text-[#b5342a] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-white/20 group-hover:text-white transition-colors duration-500">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-bold mb-4">{{ $settings['why_us_1_title'] ?? 'Lightning Fast Speed' }}</h3>
                    <p class="text-gray-600 group-hover:text-white/90 transition-colors duration-500">
    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
        ...
        <div class="relative w-full overflow-hidden">
            ...
            <div class="flex w-max animate-marquee">
                @php
                    $avatarColors = ['bg-blue-500', 'bg-[#b5342a]', 'bg-green-500', 'bg-[#1e3040]', 'bg-yellow-500', 'bg-[#7a7a6a]'];
                @endphp
                {{-- Set 1 --}}
                <div class="flex">
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="grid md:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <!-- Newsletter Signup -->
                    <div class="relative">
                        <input type="email" placeholder="Enter your email" class="w-full bg-white/10 border border-white/20 rounded-full py-2 px-4 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-[#b5342a] transition">
                        <button class="absolute right-1 top-1 bg-[#b5342a] hover:bg-[#1e3040] text-white rounded-full p-1.5 transition">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('welcome') }}" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Home</a></li>
                        <li><a href="{{ route('about') }}" class="footer-link text-gray-300 hover:text-[#b5342a] transition">About Us</a></li>
                        <li><a href="{{ route('shop') }}" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Shop</a></li>
                        <li><a href="#topup" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Top Up</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Mobile Data</a></li>
                        <li><a href="#" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Fiber Internet</a></li>
                        <li><a href="#" class="footer-link text-gray-300 hover:text-[#b5342a] transition">M-Pesa Services</a></li>
                        <li><a href="#" class="footer-link text-gray-300 hover:text-[#b5342a] transition">Corporate Solutions</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center text-gray-300 text-sm">
                            <svg class="w-4 h-4 mr-2 text-[#b5342a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        ...
                        <li class="flex items-center text-gray-300 text-sm">
                            <svg class="w-4 h-4 mr-2 text-[#b5342a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            info@safeworld.co.ke
                        </li>
                    </ul>
                    <!-- Social Media Icons -->
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#b5342a] transition-all duration-300 hover:scale-110">
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 text-sm">
                    <a href="#" class="text-gray-400 hover:text-[#b5342a] transition">Privacy Policy</a>
                    <a href="#" class="text-gray-400 hover:text-[#b5342a] transition">Terms of Service</a>
                    <a href="#" class="text-gray-400 hover:text-[#b5342a] transition">Cookie Policy</a>
                </div>
            </div>
        </div>
    </footer>
