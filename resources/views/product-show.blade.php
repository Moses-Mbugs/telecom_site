    ...
    @if (isset($shopPage) && $shopPage->product_banner_image)
        <div class="container mx-auto px-4 pt-6">
            @if ($shopPage->product_banner_link)
                <a href="{{ $shopPage->product_banner_link }}" target="_blank" rel="noopener">
                    <img src="{{ $shopPage->product_banner_image }}" alt="Advertisement" class="w-full rounded-2xl shadow-lg object-cover">
                </a>
            @else
                <img src="{{ $shopPage->product_banner_image }}" alt="Advertisement" class="w-full rounded-2xl shadow-lg object-cover">
            @endif
