...
@section('page-title', 'Add Career Listing')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 class="text-lg font-semibold text-gray-700 mb-6">New Career Position</h2>
        ...
        <form action="{{ route('admin.careers.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Include responsibilities, requirements, and any relevant details.</p>
            </div>
